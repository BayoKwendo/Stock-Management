  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  		...
			  		for($x = 1; $x < 4; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control selectpicker" data-live-search="true" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {									 		
			  								echo "<option value='".$row['product_id']."'  data-tokens='".$row['product_name']."'  id='changeProduct".$row['product_id']."'>".$row['product_name']."</option>";
										 	} // /while 
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" value="0" name="discount" onkeyup="discountFunc()" autocomplete="off" disabled />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
			  					...
			  					<select class="form-control selectpicker" data-live-search="true" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {									 		
			  								...
			  								echo "<option value='".$row['product_id']."'  data-tokens='".$row['product_name']."' id='changeProduct".$row['product_id']."' ".$selected." >".$row['product_name']."</option>";
										 	} // /while 
